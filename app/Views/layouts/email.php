                        ...
                        <tr>
                            <td style="padding: 20px 0px 30px 0px;" class="logo">
                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td bgcolor="#ffffff" width="100" align="left"><a href="<?= base_url() ?>" target="_blank"><img alt="Logo" src="<?= base_url('favicon.ico') ?>" width="52" height="78" style="display: block; font-family: Helvetica, Arial, sans-serif; color: #666666; font-size: 16px;" border="0"></a></td>
                                        <td bgcolor="#ffffff" width="400" align="right" class="mobile-hide">
                                            <table border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td align="right" style="padding: 0 0 5px 0; font-size: 14px; font-family: Arial, sans-serif; color: #666666; text-decoration: none;"><span style="color: #666666; text-decoration: none;"><?= getenv('app.name') ?></span></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                            ...
                            <table width="500" border="0" cellspacing="0" cellpadding="0" align="center" class="responsive-table">
                                <tr>
                                    <td align="center" valign="middle" style="font-size: 12px; line-height: 18px; font-family: Helvetica, Arial, sans-serif; color:#666666;">
                                        <a href="<?= base_url() ?>" target="_blank" style="color: #666666; text-decoration: none;">
                                        <span class="appleFooter" style="color:#666666;"><?= getenv('app.name') ?></span>
                                        </a><br>
                                        <span class="appleFooter" style="color:#666666;"><?= date('Y') ?> - All Rights Reserved.</span>

                                        <!-- <a style="color: #666666; text-decoration: none;">Don't need news letter</a>
