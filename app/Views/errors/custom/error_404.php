...
<?= $this->section('title') ?>Error Page Not Found<?= $this->endSection() ?>
...
<div class="container">
    <div class="mt-2">
        ...
        <div class="text-center" style="margin-bottom: -50px;">
            <a href="<?= base_url('/') ?>" class="btn btn-primary btn-lg m-2"><i class="fa fa-home"></i>
                Take Me Home 
            </a>
            <a href="<?= base_url('/contact') ?>" class="btn btn-info btn-lg m-2">
            <i class="fa fa-edit"></i> Contact Support 
            </a>
        </div>
        <div class="main">
